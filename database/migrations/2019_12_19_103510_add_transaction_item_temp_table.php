...
class AddTransactionItemTempTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('transaction_item_temp', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('transaction_item_temp');
    }
}
