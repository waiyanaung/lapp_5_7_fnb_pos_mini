            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        {{-- <span class="db"><img src="/backend/matrix_admin/assets/images/logo2.png" alt="logo" /></span> --}}
                    ...
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" action="/backend_app/login" method="post">
                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" required="" name="user_name" id="username" value="{{ Request::old('user_name') }}">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                    <a class="btn btn-info" href="{{ url('/backend_app/password/reset') }}">   <i class="fa fa-lock m-r-5"></i> Lost password ?</a>
