...
<div id="content" class="content">
    ...
    <h1 class="page-header">{{trans('setup_email_template.booking-edit-edit') }}</h1>
        {!! Form::open(array('url' => '/backend_app/email_template_booking_edit/update','id'=>'booking-cancel', 'class'=> 'form-horizontal user-form-border')) !!}
