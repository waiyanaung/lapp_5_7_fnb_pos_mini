...
<div id="content" class="content">
    ...
    <h1 class="page-header">{{trans('setup_email_template.booking-cancel-edit') }}</h1>
        {!! Form::open(array('url' => '/backend_app/email_template_booking_cancel/update','id'=>'booking-cancel', 'class'=> 'form-horizontal user-form-border')) !!}
