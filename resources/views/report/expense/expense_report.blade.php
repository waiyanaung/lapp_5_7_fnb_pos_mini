        ...
        <div class="col-md-12 text-right">
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="button" onclick='form_submit("export_pdf");' class="btn btn-primary btn-md">Export
                        Excel</button>
                    <button type="button" onclick='form_submit("export_excel");' class="btn btn-primary btn-md">Export
                        PDF</button>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function form_submit(type) {
        ...
        if(type == "export_pdf"){
            $('#frm_expense').attr('action', '/backend_app/report/expense/pdf');
            $("#frm_expense").submit();
        }
        else if(type == "export_excel"){
            $('#frm_expense').attr('action', '/backend_app/report/expense/excel');
            $("#frm_expense").submit();
        }
        else{
            $('#frm_expense').attr('action', '/backend_app/report/expense');
            $("#frm_expense").submit();
        }
    }
